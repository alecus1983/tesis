...
El cambiador de tomas es un equipo  para cambiar las conexiones de derivación del devanado de un transformador en estado energizado o en carga, estos son diseñados bajo los criterios de la norma IEC 60214-1 \cite{IEC60214}.
...
%\includegraphics[width=0.7\linewidth]{imagenes/cap_2/L%DC}
%\end{figure}
...
\begin{longtable}{|p{3cm}|c|p{3cm}|p{6cm}|c|}
	...
	\hline
	\endlastfoot
	\multirow{5}{3 cm}{Planeamiento de la red}
	 ...
	 \multirow{2}{3 cm}{Capacidad de almacenamiento} 
